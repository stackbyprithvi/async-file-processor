...
import { getVideoMetadata } from ".././services/ffprobe.service.js";
import { createVideoMetadata } from ".././repositories/videoMetadata.repository.js";
...
export async function processVideoJob(job) {
  ...
  try {
    ...
    console.log("✅ ffmprobe finished");

    const videoMetadata = await createVideoMetadata(jobId, metadata);
    ...
    const completedJob = await findJobByIdJoin(jobId);
